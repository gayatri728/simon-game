🎮 Simon Says Game
An interactive Simon Says memory game built using HTML, CSS, and JavaScripT. The game tests your memory by generating a sequence of colors that you must repeat correctly.
